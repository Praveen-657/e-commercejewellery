            ...
            FadeInUp(duration: Duration(milliseconds: 1000), child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('assets/images/background jewellery.jpg'),
                      fit: BoxFit.cover
                  )
              ),
              child: Container(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        makeCategory(image: 'assets/images/set1.jpg', title: 'jewellery', tag: 'jewellery'),
                        makeCategory(image: 'assets/images/haram.jpg', title: 'bridal gold haram', tag: 'devote jewellery'),
                        makeCategory(image: 'assets/images/necklace.jpeg', title: 'necklace', tag: 'jewellery'),
                        makeCategory(image: 'assets/images/chokar.jpg', title: 'chokar', tag: 'jewellery'),
                      ],
                    ),
                  ),
                  SizedBox(height: 40,),
                  ...
                  Container(
                    ...
                    child: ListView(
                      scrollDirection: Axis.horizontal,
                      children: <Widget>[
                        makeBestCategory(image: 'assets/images/bracelet.jpg', title: 'bracelet for men'),
                        makeBestCategory(image: 'assets/images/bracelet1.jpeg', title: 'bracelet for women'),
                        makeBestCategory(image: 'assets/images/chain.jpeg', title: 'chain'),
                        makeBestCategory(image: 'assets/images/bangles.jpg', title: 'bangles'),
                      ],
                    ),
                  ),
                  SizedBox(height: 80,),
